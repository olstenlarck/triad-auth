create table "user" ("id" text not null primary key, "name" text not null, "email" text not null unique, "emailVerified" integer not null, "image" text, "createdAt" date not null, "updatedAt" date not null, "accountSub" text not null, "provider" text not null, "providerSub" text not null, "providerEmail" text, "providerName" text, "providerHandle" text, "providerAvatar" text, "providerEmailVerified" integer not null);
